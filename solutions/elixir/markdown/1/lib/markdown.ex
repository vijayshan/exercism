defmodule Markdown do
  ...
  # Spliting the string an rejoining is going to contaminate the data There should be
  # a better way of looking at the data for the count
  ...
  # a function to enclose the given term in a particular tag
  defp enclose_with_tag(w, tag), do: "<#{tag}>#{w}</#{tag}>"

  # use a regex and then stich and then traverse in reverse
  def patch(l) do
