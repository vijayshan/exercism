defmodule MarkdownTest do
  ...
  # added this test to have multiple lists in one block
  # @tag :pending
  test "multiple unordered lists" do
    input = "* Item 1\n* Item 2\n###### This will be an h6\n* Item 1\n* Item 2"
    expected = "<ul><li>Item 1</li><li>Item 2</li></ul><h6>This will be an h6</h6><ul><li>Item 1</li><li>Item 2</li></ul>"
    assert Markdown.parse(input) == expected
  end
end
